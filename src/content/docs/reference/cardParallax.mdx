---
title: "Card Parallax"
description: Diseño Card efecto parallax.
---

import CardParallax from "@/components/referencias/cardparallax/CardParallax.tsx";
import Cita from "@/components/Cita.astro"

## Componente enriquecido con GSAP.

Diseño Card con efecto Parallax enriquecido con GSAP:

<br />
<CardParallax client:load/>
<Cita nombre="Jhey" hiperv="https://x.com/@jh3yy"/>
<br />

###### HTML

```html {8} title="CardParallax.astro"
<a
  class="bear-link"
...
:::note
Tanto el **CSS**  como el **JS** se pueden embeber dentro del mismo componente o en un archivos por separados lo que es más recomendable para mayor escalabilidad y una sola responsabilidad de dependencias.
:::

###### CSS

```css {8} title="CardParallax.astro"
...
const START = () => {
  const DeviceOrientationEventWithPermission = DeviceOrientationEvent as unknown as DeviceOrientationEventWithPermission;
  if (
...
```@/components/referencias/cardparallax/CardParallax.js
